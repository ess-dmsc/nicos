...
devices = dict(
    ...
    det1_hv_supply=device(
        "nicos_mlz.sans1.devices.hv.VoltageSupply",
    ...
    det1_hv_offtime=device(
        "nicos_mlz.sans1.devices.hv.HVOffDuration",
    ...
    det1_hv=device(
        ...
        moveable="det1_hv_ax",
        mapping={"ON": (1500, 1), "LOW": (36, 33), "OFF": (0, 2)},
        precision=1,
        unit="",
        fallback="unknown",
    ),
    ...
    det1_zmot=device(
        "nicos_mlz.sans1.devices.hv.ZMotor",
    ...
    bs1_xenc=device(
        "nicos_mlz.sans1.devices.sensor.FunnySensor",
