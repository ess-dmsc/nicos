...
_htf03 = Block(
    ...
    [
        BlockRow(
            ...
            Field(
                name="Target", key="t_htf03/target", format="%.2f", unit="C", width=12
            ),
        ),
        BlockRow(
            Field(
...
_htf01 = Block(
    ...
    [
        BlockRow(
            ...
            Field(
                name="Target", key="t_htf01/target", format="%.2f", unit="C", width=12
            ),
        ),
        BlockRow(
            Field(
...
_irf01 = Block(
    ...
    [
        BlockRow(
            ...
            Field(
                name="Target", key="t_irf01/target", format="%.2f", unit="C", width=12
            ),
        ),
        BlockRow(
            Field(
...
_irf10 = Block(
    ...
    [
        BlockRow(
            Field(name="Temperature", dev="T_irf10", format="%.2f", unit="C", width=12),
            Field(
                name="Target", key="t_irf10/target", format="%.2f", unit="C", width=12
            ),
        ),
        BlockRow(
            Field(
...
for k in [1, 2, 3, 10, 11, 12]:
    rscs.append(
        Block(
            ...
            [
                BlockRow(
                    Field(name="Position", dev="sth_rsc%02d" % k, unitkey="t/unit"),
                ),
            ],
            setups="rsc%02d" % k,
        )
    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(
                    name="Flow out", dev="flow_out_memograph", unit="l/min", width=6.5
                ),
...
_sans1julabo = Block(
    ...
    [
        ...
        BlockRow(
            Field(
                name="Setpoint Intern",
                key="T_julabo_intern/setpoint",
                format="%.1f",
                unit="C",
                width=16,
            ),
            Field(
                name="Heater Power Intern",
                key="T_julabo_intern/heateroutput",
                format="%.1f",
                unit="%",
                width=16,
            ),
        ...
        BlockRow(
            Field(
                name="Setpoint Extern",
                key="T_julabo_extern/setpoint",
                format="%.1f",
                unit="C",
                width=16,
            ),
            Field(
                name="Heater Power Extern",
                key="T_julabo_extern/heateroutput",
                format="%.1f",
                unit="%",
                width=16,
            ),
...
_dilato = Block(
    ...
    [
        BlockRow(
            Field(name="Temperature", dev="Ts_dil", format="%.2f", unit="C", width=14),
            Field(
                name="Set Temp", dev="dil_set_temp", format="%.2f", unit="C", width=14
            ),
        ),
        BlockRow(
            Field(
                name="Length change", dev="dil_dl", format="%.2f", unit="um", width=14
            ),
            Field(name="Force", dev="dil_force", format="%.2f", unit="N", width=14),
        ),
        BlockRow(
            Field(name="Power", dev="dil_power", format="%.2f", unit="%", width=14),
            Field(name="Time", dev="dil_time", format="%.2f", unit="s", width=14),
        ),
    ],
    setups="dilato",
)
...
_dilato_plot2 = Block(
    "Dilatometer plot length change",
    [
        BlockRow(
            Field(
                widget="nicos.guisupport.plots.TrendPlot",
...
_fg1 = Block(
    ...
    [
        ...
        BlockRow(
            ...
            Field(
                name="Dutycycle", key="tisane_fg1/duty", format="%i", unit="%", width=12
            ),
        ),
    ],
    setups="frequency",
...
_fg2 = Block(
    ...
    [
        ...
        BlockRow(
            ...
            Field(
                name="Dutycycle", key="tisane_fg2/duty", format="%i", unit="%", width=12
            ),
        ),
    ],
    setups="frequency",
