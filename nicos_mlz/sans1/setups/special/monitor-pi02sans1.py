...
_dilato = Block(
    ...
    [
        BlockRow(
            Field(name="Temperature", dev="Ts_dil", format="%.2f", unit="C", width=16),
            Field(
                name="Set Temp", dev="dil_set_temp", format="%.2f", unit="C", width=16
            ),
        ),
        BlockRow(
            Field(
                name="Length change", dev="dil_dl", format="%.2f", unit="um", width=16
            ),
            Field(name="Force", dev="dil_force", format="%.2f", unit="N", width=16),
        ),
        BlockRow(
            Field(name="Power", dev="dil_power", format="%.2f", unit="%", width=16),
            Field(name="Time", dev="dil_time", format="%.2f", unit="s", width=16),
        ),
    ],
    setups="dilato",
)
