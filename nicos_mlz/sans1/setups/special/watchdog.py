...
watch_conditions = [
    ...
    dict(
        condition="t_in_memograph_value > 20",
    ...
    #    ),
    dict(
        condition="ReactorPower_value < 4.5",
    ...
    dict(
        condition="ccm5h_T_topleft_value > 4.5",
    ...
    dict(
        condition="p_diff_filter_value > 0.5",
    ...
    #    ),
    dict(
        condition="selector_rpm_value > 30000",
