    ...
    Block(
        ...
        [
            ...
            BlockRow(
                ...
                Field(
                    name="Flow out", dev="flow_out_memograph", width=12, unit="l/min"
                ),
    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(plot="30 min irf10", name="Setpoint", dev="T_irf10/setpoint"),
                ...
                Field(plot="12 h irf10", name="Setpoint", dev="T_irf10/setpoint"),
    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(plot="30 min htf01", name="Setpoint", dev="T_htf01/setpoint"),
                ...
                Field(plot="12 h htf01", name="Setpoint", dev="T_htf01/setpoint"),
    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(
                    plot="julabo 30min", name="T Julabo extern", dev="T_julabo_extern"
                ),
                Field(
                    plot="julabo 12h",
                    name="T Julabo intern",
                ...
                Field(plot="julabo 12h", name="T Julabo extern", dev="T_julabo_extern"),
            ),
        ],
        setups="julabo",
    ),
...
_dilato = Column(
    Block(
        ...
        [
            BlockRow(
                Field(
                    name="Temperature", dev="Ts_dil", format="%.2f", unit="C", width=14
                ),
                Field(
                    name="Set Temp",
                    dev="dil_set_temp",
...
_col_slit = Column(
    Block(
        ...
        [
            BlockRow(
                Field(name="Top", dev="slit_top", unit="mm", format="%.2f", width=12),
            ),
            BlockRow(
                Field(name="Left", dev="slit_left", unit="mm", format="%.2f", width=12),
                Field(
                    name="Right", dev="slit_right", unit="mm", format="%.2f", width=12
                ),
            ),
            BlockRow(
                Field(
                    name="Bottom", dev="slit_bottom", unit="mm", format="%.2f", width=12
                ),
            ),
            BlockRow(
