...
_selcolumn = Column(
    Block(
        ...
        [
            ...
            BlockRow(
                Field(
                    name="selector_tilt", dev="selector_tilt", width=12, format="%.1f"
                ),
            ),
            BlockRow(
            ...
            BlockRow(
                Field(
                    name="rotor temp.", dev="selector_rtemp", width=12, format="%.1f"
                ),
            ),
        ],
    ),
...
_tisane = Column(
    Block(
        ...
        [
            ...
            BlockRow(
                Field(
                    name="Chopper 1", dev="chopper_ch1_speed", width=12, format="%.1f"
                ),
            ),
            BlockRow(
                Field(
                    name="Chopper 2", dev="chopper_ch2_speed", width=12, format="%.1f"
                ),
            ),
            BlockRow(
            ...
            BlockRow(
                Field(
                    name="water flow", dev="chopper_waterflow", width=12, format="%.2"
                ),
            ),
        ],
        setups="chopper",
    ...
    Block(
        ...
        [
            ...
            BlockRow(
                ...
                Field(
                    name="det1_omg", dev="det1_omg", width=12, unit="deg", format="%.0f"
                ),
