...
devices = dict(
    ...
    ccmsanssc_coder=device(
        "nicos.devices.entangle.Sensor",
        visibility=(),
        tangodevice=tango_base + "phytron/coder",
        unit="mm",
    ),
    ccmsanssc_axis=device(
        "nicos_mlz.sans1.devices.ccmsanssc.SwordAxis",
