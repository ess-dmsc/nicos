...
devices = dict(
    ...
    co_att=device(
        ...
        bus="motorbus6",
        addr=91,
        poly=[-124422 / 2912.7111, 1.0 / 2912.7111],
        unit="deg",
        circular=-360,
        visibility=(),
    ),
    co_ath=device(
        ...
        bus="motorbus6",
        addr=90,
        poly=[-476397 / 2912.7111, 1.0 / 2912.7111],
        unit="deg",
        visibility=(),
    ),
    att=device(
    ...
    st_afpg=device(
        "nicos_mlz.puma.devices.ipc.Motor2",
        bus="motorbus6",
        addr=68,
        slope=380.5,
        unit="deg",
