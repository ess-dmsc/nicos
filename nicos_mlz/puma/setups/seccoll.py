...
devices = dict(
    sca1b=device(
        "nicos_mlz.puma.devices.SecCollBlockChanger",
    ...
    sca1=device(
        "nicos_mlz.puma.devices.SecCollLift",
    ...
    a2dia=device(
        "nicos_mlz.puma.devices.SecCollPair",
    ...
    alpha2=device(
        "nicos_mlz.puma.devices.SecondaryCollimator",
