...
devices = dict(
    coil_1=device(
        "nicos_mlz.panda.devices.guidefield.VectorCoil",
    ...
    gf=device(
        "nicos_mlz.panda.devices.guidefield.GuideField",
    ...
    sf1=device(
        "nicos.devices.polarized.KFlipper",
