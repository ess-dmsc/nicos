...
devices = {
    "T_%s_control1" % setupname: device(
    ...
    "T_%s_control2" % setupname: device(
        "nicos.devices.entangle.TemperatureController",
        description="Loop 2",
