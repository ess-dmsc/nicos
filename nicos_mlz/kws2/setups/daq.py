...
devices = dict(
    kwsformat=device(
        "nicos_mlz.kws2.devices.kwsfileformat.KWSFileSink",
        transpose=True,
        detectors=["det"],
    ),
    yamlformat=device(
        "nicos_mlz.kws2.devices.yamlformat.YAMLFileSink",
        detectors=["det"],
    ),
    binaryformat=device(
        "nicos_mlz.kws1.devices.yamlformat.BinaryArraySink",
        detectors=["det"],
    ),
    ...
    det_img_ge=device(
        "nicos_mlz.kws1.devices.daq.GEImageChannel",
    ...
    det_img_jum=device(
        "nicos_mlz.kws1.devices.daq.KWSImageChannel",
    ...
    det_roi=device(
        "nicos_mlz.kws1.devices.daq.ROIRateChannel",
    ...
    det=device(
        "nicos_mlz.kws1.devices.daq.KWSDetector",
