...
_column1 = Column(
    Block(
        ...
        [
            BlockRow(
                Field(dev="ep%02d_T" % ep, name="ep%d" % ep),
...
_column1b = Column(
    Block(
        ...
        [
            BlockRow(
                Field(dev="ep%02d_TB" % ep, name="ep%d" % ep),
...
_column2 = Column(
    Block(
        ...
        [
            BlockRow(
                Field(dev="ep%02d_HV" % ep, name="ep%d" % ep),
...
_column3 = Column(
    ...
    Block(
        ...
        [
            BlockRow(
                Field(
                    plot="HVs", dev="ep01_HV", width=50, height=15, plotwindow=24 * 3600
                ),
