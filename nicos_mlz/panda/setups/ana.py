...
devices = dict(
    ...
    att_step=device(
        "nicos.devices.vendor.ipc.Motor",
        bus="bus1",
        addr=MOTOR(1),
        slope=-200,
        unit="deg",
    ...
    att_enc=device(
        "nicos.devices.vendor.ipc.Coder",
        bus="bus1",
        addr=CODER(1),
        slope=-(2**20) / 360.0,
        zerosteps=854914,
    ...
    # ),
    afh_pg=device(
        "nicos_mlz.panda.devices.rot_axis.RotAxis",
