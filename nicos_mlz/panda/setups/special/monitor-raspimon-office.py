...
lakeshoreplot = Block(
    ...
    [
        BlockRow(
            Field(dev="T", plot="T", plotwindow=12 * 3600, width=30, height=20),
            Field(dev="Ts", plot="T", plotwindow=12 * 3600, width=30, height=20),
        ),
    ],
    setups="lakeshore",
)
...
wm5vplots = Block(
    ...
    [
        BlockRow(
            Field(dev="wm5v_pvti", plot="p", plotwindow=3600, width=30, height=20),
            Field(dev="wm5v_nv_manual", plot="p", plotwindow=3600, width=30, height=20),
        ),
        BlockRow(
            Field(
                dev="T_wm5v_vti", plot="Tmag", plotwindow=12 * 3600, width=30, height=20
            ),
            Field(
                dev="T_wm5v_sample",
                plot="Tmag",
        ...
        BlockRow(
            Field(
                dev="wm5v_lhe", plot="lhe", plotwindow=12 * 3600, width=30, height=20
            ),
        ),
    ],
    setups="wm5v",
...
foki = Block(
    "Foki",
    [
        BlockRow(Field(dev="mfh"), Field(dev="mfv"), Field(dev="afh")),
    ],
)
...
column1 = Column(filters, primary, sample, analyzer) + Column(ccm5v5supp, wm5vsupp)

column2 = (
    Column(detector, bambus)
    + Column(*cryos)
    + Column(*ccrs)
