...
tas = Block(
    ...
    [
        BlockRow(
            Field(name="H", key="panda/value[0]", format="%.3f", unit=""),
        ...
        BlockRow(
            Field(name="Mode", key="panda/scanmode"),
...
column2 = (
    Column(collimation, detector, ccm12v)
    + Column(*cryos)
    + Column(*ccrs)
...
column3 = (
    Column(tas) + Column(ccm5v5supp, wm5vsupp, foki, memograph) + Column(*cryosupps)
)
