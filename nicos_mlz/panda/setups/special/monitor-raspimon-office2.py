...
lakeshoreplot = Block(
    ...
    [
        BlockRow(
            Field(dev="T", plot="T", plotwindow=12 * 3600, width=45, height=30),
            Field(dev="Ts", plot="T", plotwindow=12 * 3600, width=45, height=30),
        ),
    ],
    setups="lakeshore",
)
...
wm5vplots = Block(
    ...
    [
        BlockRow(
            Field(dev="wm5v_pvti", plot="p", plotwindow=3600, width=45, height=25),
            Field(dev="wm5v_nv_manual", plot="p", plotwindow=3600, width=45, height=25),
        ),
        BlockRow(
            Field(
                dev="T_wm5v_vti", plot="Tmag", plotwindow=12 * 3600, width=45, height=25
            ),
            Field(
                dev="T_wm5v_sample",
                plot="Tmag",
        ...
        BlockRow(
            Field(
                dev="wm5v_lhe", plot="lhe", plotwindow=12 * 3600, width=45, height=20
            ),
        ),
    ],
    setups="wm5v",
