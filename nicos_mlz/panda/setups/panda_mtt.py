...
devices = dict(
    ...
    diag_automove=device(
        "nicos.devices.entangle.DigitalInput",
        description="Diagnostic information for function block " '"MTT_Auto_Move".',
    ...
    diag_bccw=device(
        "nicos.devices.entangle.DigitalInput",
        description="Diagnostic information for function block " '"MB_WECHSEL_TO_CCW".',
    ...
    diag_bcw=device(
        "nicos.devices.entangle.DigitalInput",
        description="Diagnostic information for function block " '"MB_WECHSEL_TO_CW".',
        tangodevice=plc + "diag_bcw",
        visibility=(),
        fmtstr="%#x",
        unit="",
    ),
    diag_switches=device(
        "nicos.devices.entangle.DigitalInput",
    ...
    mb_arm_magnet=device(
        "nicos.devices.entangle.NamedDigitalOutput",
        description="Device for switching the magnet in the mobile arm on " "and off.",
    ...
    mb_arm_inc_encoder=device(
        "nicos.devices.entangle.Sensor",
        description='Normalized value of the "MB_ARM" axis incremental ' "encoder.",
    ...
    mtt=device(
        "nicos_mlz.panda.devices.debug.InvertablePollMotor",
    ...
    mtt_abs_encoder=device(
        "nicos.devices.entangle.Sensor",
        description='Normalized value of the "MTT_RAW" axis absolute ' "encoder.",
        tangodevice=plc + "mttabsencoder",
        unit="steps",
    ),
    mtt_inc_encoder=device(
        "nicos.devices.entangle.Sensor",
        description='Normalized value of the "MTT_RAW" axis incremental ' "encoder.",
