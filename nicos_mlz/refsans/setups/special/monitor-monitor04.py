    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(
                    name="internal bath temperature ",
                    dev="julabo_int",
                    width=10,
                    format="%.2f",
                    unit="(\u2103)",
...
_syringepumps = Column(
    Block(
        "Syringe Pumps Status",
        [
            BlockRow(
                Field(
                    name="[Pump 0] syringe diameter",
                    dev="pump0_diameter",
                    width=10,
                    format="%.2f",
                    unit="(mm)",
                ...
                Field(
                    name="[Pump 0] injection/withdraw flux",
                    dev="pump0_rate",
                    width=10,
                    format="%.2f",
                    unit="(ml/min)",
                ...
                Field(
                    name="[Pump 0] volume injected/withdrawn",
                    dev="pump0_run",
                    width=10,
                    format="%.2f",
                    unit="(ml)",
            ...
            BlockRow(
                ...
                Field(
                    name="[Pump 1] injection/withdraw flux",
                    dev="pump1_rate",
                    width=10,
                    format="%.2f",
                    unit="(ml/min)",
                ...
                Field(
                    name="[Pump 1] volume injected/withdrawn",
                    dev="pump1_run",
                    width=10,
                    format="%.2f",
                    unit="(ml)",
    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(
                    name="Gonio Z", dev="gonio_z", width=10, format="%.2f", unit="(mm)"
                ),
                Field(
                    name="height", dev="height", width=10, format="%.2f", unit="(mm)"
                ),
            ),
        ],
        setups="nima",
...
_ubahn = Column(
    Block(
        "U6 Subway to Klinikum Gro\u00dfhadern",
        [
            BlockRow(
