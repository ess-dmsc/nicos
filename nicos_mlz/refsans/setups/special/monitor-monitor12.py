...
_ChopperBurg = Column(
    Block(
        "Vertical Shifts for Optic Elements in the Chopper System",
        [
            BlockRow(
                Field(
                    name="nok2\u1d63",
...
_ChopperBurgQAD = Column(
    Block(
        "Vertical Shifts for Optic Elements in the Chopper System QAD",
        [
            BlockRow(
...
_SFKammer = Column(
    Block(
        "Vertical Shifts for Optic Elements in the Neutron Guide System",
        [
            BlockRow(
                Field(
                    name="nok5a\u1d63",
            ...
            BlockRow(
                ...
                Field(
                    name="zb\u2083", dev="zb3.center", width=layout_width, unit="(mm)"
                ),
                Field(
                    name="nok8\u1d63",
                    dev="nok8.reactor",
                ...
                Field(
                    name="bs\u2081", dev="bs1.center", width=layout_width, unit="(mm)"
                ),
                Field(
                    name="nok9\u1d63",
                    dev="nok9.reactor",
...
_SFKammerQAD = Column(
    Block(
        "Vertical Shifts for Optic Elements in the Neutron Guide System QAD",
        [
            BlockRow(
...
_probort = Column(
    Block(
        "Vertical/Horizontal Shifts for Optic Elements at Sample Position",
        [
            BlockRow(
...
_apertures_slits = Column(
    Block(
        "Apertures for movable slits",
        [
            BlockRow(
                Field(name="b\u2081", dev="b1.height", width=layout_width, unit="(mm)"),
                Field(
                    name="zb\u2083", dev="zb3.height", width=layout_width, unit="(mm)"
                ),
                Field(
                    name="bs\u2081", dev="bs1.height", width=layout_width, unit="(mm)"
                ),
