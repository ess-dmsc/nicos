...
for ele in _condition_liste:
    ...
    for i in range(len(keystr)):
        _r.append(Field(name=ele, key=ele + "/" + keystr[i], width=keywidth[i]))
    _condition_array.append(BlockRow(*_r))

_conditioncolumn = Column(
    Block(str(keystr), _condition_array),
)
...
_corescolumn = Column(
    Block("cores", _cores_array),
)

_speed_liste = _condition_liste + [
    "cpt1",
]
_speed_array = []
...
_speed_plot = Block(
    "speed %d%s" % (Time_selection1[0], Time_selection1[1]),
    [
        BlockRow(
            Field(
...
Elemente2 = ["sds"]
_sds_plot = Block(
    "SDS wegen Brakes of disc34 %d%s" % (Time_selection2[0], Time_selection2[1]),
    [
        BlockRow(
            Field(
                widget="nicos.guisupport.plots.TrendPlot",
...
_cores_plot = Block(
    "cores %d%s" % (Time_selection_core[0], Time_selection_core[1]),
    [
        BlockRow(
            Field(
                widget="nicos.guisupport.plots.TrendPlot",
...
_one_row_3_4 = Column(
    ...
    Block(
        ...
        [
            BlockRow(
                Field(
                    picture="/control/webroot/live_lin.png",
                    width=30,
                    height=15,
                    refresh=10,
                ),
...
he = 15  # 37
_plot1_1_bl = Block(
    "History motor %d%s" % (Time_selection1[0], Time_selection1[1]),
    [
        BlockRow(
            Field(
                widget="nicos.guisupport.plots.TrendPlot",
...
_plot1_1 = Column(_plot1_1_bl)

_plot1_2 = Column(
    Block(
        "History motor %d%s" % (Time_selection2[0], Time_selection2[1]),
        [
            BlockRow(
                Field(
                    widget="nicos.guisupport.plots.TrendPlot",
...
_plot2_1 = Column(
    Block(
        "History acc %d%s" % (Time_selection1[0], Time_selection1[1]),
        [
            BlockRow(
                Field(
                    widget="nicos.guisupport.plots.TrendPlot",
...
_plot2_2 = Column(
    Block(
        "History acc %d%s" % (Time_selection2[0], Time_selection2[1]),
        [
            BlockRow(
                Field(
                    widget="nicos.guisupport.plots.TrendPlot",
...
_plot_one_column = Column(
    Block(
        "Reactor %d%s" % (Time_selection1[0], Time_selection1[1]),
        [
            BlockRow(
                Field(
                    widget="nicos.guisupport.plots.TrendPlot",
    ...
    Block(
        "SafeDetectorSystem %d%s" % (Time_selection2[0], Time_selection2[1]),
        [
            BlockRow(
                Field(
                    widget="nicos.guisupport.plots.TrendPlot",
