...
_NLHcol = Column(
    Block(
        "FRM-II and Guide Hall Information",
        [
            BlockRow(
                Field(
                    name="reactor power",
    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(
                    name="user(s)", key="exp/users", width=60, istext=True, maxlen=60
                ),
            ),
            BlockRow(
                Field(
                    name="Remark", key="exp/remark", width=80, istext=True, maxlen=80
                ),
            ),
            BlockRow(
                Field(
    ...
    Block(
        ...
        [
            ...
            BlockRow(
                ...
                Field(
                    name="sample-last slit distance",
                    dev="d_last_slit_sample",
                    width=10,
                    format="%.0f",
                    unit="(mm)",
                ),
...
_justierung = Column(
    Block(
        "Aligment Devices Status",
        [
            BlockRow(
                Field(
                    name="autocollimator angle \u03b8",
                    dev="autocollimator_theta",
                    width=7,
                    format="%.3f",
                    unit="(deg)",
                ),
                Field(
                    name="autocollimator angle \u03c6",
                    dev="autocollimator_phi",
                    width=7,
                    format="%.3f",
                    unit="(deg)",
                ),
...
_detector = Column(
    Block(
        ...
        [
            BlockRow(
                Field(
                    name="table", dev="det_table", width=10, format="%.0f", unit="(mm)"
                ),
                Field(
                    name="yoke", dev="det_yoke", width=10, format="%.0f", unit="(mm)"
                ),
...
_monitor = Column(
    Block(
        ...
        [
            ...
            BlockRow(
                Field(
                    name="monitor-last slit distance",
                    dev="prim_monitor_x",
                    width=10,
                    format="%.0f",
                    unit="(mm)",
...
_dettube = Column(
    Block(
        " Detector Tube Status",
        [
            BlockRow(
                Field(
                    widget="nicos_mlz.refsans.gui.monitorwidgets.RefsansWidget",
                    width=50,
                    height=40,
                    pivot="det_pivot",
                    detpos="det_table",
