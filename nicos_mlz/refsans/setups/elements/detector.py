...
devices = dict(
    ...
    det_yoke_skew=device(
        code_base + "skew_motor.SkewRead",
    ...
    det_table_motor=device(
        code_base + "analogencoder.AnalogMove",
        ...
        poly=[
            -211.5,
            1.00460,
        ],  # 2021-03-23 09:08:58 GM Laser poly = [-513.0, 0.9955], #2021-03-15 06:58:01 MP QAD Pluto 30Grad
        # poly = [-513.0, 0.9955], # 2021-03-15 06:58:01 MP QAD Pluto 30Grad
        precision=10,
        visibility=(),
    ),
    det_table_acc=device(
        code_base + "accuracy.Accuracy",
    ...
    det_table=device(
        code_base + "focuspoint.FocusPoint",
    ...
    det_table_ctrl=device(
        code_base + "controls.TemperatureControlled",
