...
devices = dict(
    ...
    basis=device(
        ...
        bitlist=[
            ...
            "Schnellschluss-Shutter_auf",
            "Schnellschluss-Shutter_zu",
            "Streurohr_Geraeumt_inv",
            "Tuer_PO_auf",
            "Tuer_PO_zu",
            "Tuer_SR_auf",
            "Tuer_SR_zu",
    ...
    Instrumentenverantwortlicher=device(
        code_base + "Group",
