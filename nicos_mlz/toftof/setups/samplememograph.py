...
devices = {
    "t_in_%s_cooling" % system[:2]: device(
    ...
    "t_out_%s_cooling" % system[:2]: device(
        "nicos.devices.entangle.Sensor",
    ...
    "p_in_%s_cooling" % system[:2]: device(
        "nicos.devices.entangle.Sensor",
    ...
    "p_out_%s_cooling" % system[:2]: device(
        "nicos.devices.entangle.Sensor",
    ...
    "flow_in_%s_cooling" % system[:2]: device(
        "nicos.devices.entangle.Sensor",
    ...
    "flow_out_%s_cooling" % system[:2]: device(
        "nicos.devices.entangle.Sensor",
    ...
    "leak_%s_cooling" % system[:2]: device(
        "nicos.devices.entangle.Sensor",
    ...
    "power_%s_cooling" % system[:2]: device(
        "nicos.devices.entangle.Sensor",
