    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(name="Title", key="exp/title", width=30, istext=True, maxlen=40),
                Field(
                    name="Sample",
...
_choppercoolingblock = Block(
    "Cooling system (Chopper)",
    [
        BlockRow(
...
_collimationblock = Block(
    "Radial Collimator/Collimation",
    [
        BlockRow(
...
_samplecoolingblock = Block(
    "Cooling system (Sample)",
    [
        BlockRow(
...
_ccrblock = Block(
    ...
    [
        ...
        BlockRow(Field(name="Vacuum/Gas", dev="ccr17_p2")),
    ],
    setups="ccr17",
)

_julabo01block = Block(
    "Sample environment",
    [
        BlockRow(
