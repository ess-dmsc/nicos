                ...
                panel(
                    ...
                    sample_panel=panel(
                        ...
                        holder_info=[
                            (
                                "Al 3-level",
                                (9, 3, "sam_trans_x", 27, "sam_trans_y", 75),
                            ),
                            (
                                "Al 3-level (narrow)",
                                (12, 3, "sam_trans_x", 20, "sam_trans_y", 75),
                            ),
                            (
                                "Cu 3-level",
                                (9, 3, "sam_trans_x", 27.125, "sam_trans_y", 113),
                            ),
                            (
                                "Cu 3-level (narrow)",
                                (16, 3, "sam_trans_x", 14.78, "sam_trans_y", 113),
                            ),
                            (
                                "Peltier 6",
                                (6, 1, "sam_trans_x", 36.56, "sam_trans_y", 0),
                            ),
                            (
                                "Peltier 8",
                                (8, 1, "sam_trans_x", 36.56, "sam_trans_y", 0),
                            ),
                            ("Red oven 4", (4, 1, "sam_trans_x", 40, "sam_trans_y", 0)),
                            (
                                "Al 2-level (wide)",
                                (9, 2, "sam_trans_x", 26.6, "sam_trans_y", 105.05),
                            ),
                            (
                                "Al 2-level (narrow)",
                                (16, 2, "sam_trans_x", 15.0, "sam_trans_y", 105.05),
                            ),
...
tools = [
    ...
    tool(
        ...
        "nicos_mlz.kws1.gui.instrconfig.InstrumentConfigTool",
        parts=[
            "shutter",
            "selector",
            "collimation",
