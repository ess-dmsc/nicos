...
PV_SCALES = {
    ...
    "ep01": [
        ("AScales", [2158, 2061, 2059, 2076, 2117, 2074, 2091, 2092]),
        ("Scales", [2245, 2239, 2226, 2259, 2236, 2245, 2240, 2236]),
    ],
    "ep02": [
        ("AScales", [2078, 2090, 2123, 2147, 2076, 2090, 2086, 2086]),
        ("Scales", [2234, 2225, 2242, 2235, 2228, 2223, 2223, 2210]),
    ],
    "ep03": [
        ("AScales", [2081, 2077, 2082, 2026, 2053, 2052, 2081, 2063]),
        ("Scales", [2218, 2247, 2245, 2229, 2238, 2241, 2247, 2251]),
    ],
    "ep04": [
        ("AScales", [2113, 2114, 2101, 2060, 2054, 2068, 2068, 2067]),
        ("Scales", [2049, 2055, 2070, 2068, 2070, 2069, 2054, 2072]),
    ],
    "ep05": [
        ("AScales", [2008, 2024, 2053, 2046, 2083, 2075, 2068, 2074]),
        ("Scales", [2058, 2056, 2064, 2061, 2082, 2082, 2077, 2070]),
    ],
    "ep06": [
        ("AScales", [2040, 2055, 2045, 2073, 2090, 2079, 2095, 2079]),
        ("Scales", [2066, 2068, 2055, 2065, 2078, 2075, 2082, 2075]),
    ],
    "ep07": [
        ("AScales", [2031, 2073, 2049, 2013, 2072, 2042, 2045, 2062]),
        ("Scales", [2058, 2062, 2054, 2059, 2059, 2066, 2073, 2059]),
    ],
    "ep08": [
        ("AScales", [2023, 2020, 2051, 2011, 2030, 2032, 2027, 2082]),
        ("Scales", [2049, 2054, 2058, 2039, 2058, 2059, 2051, 2067]),
    ],
    "ep09": [
        ("AScales", [2055, 2051, 2034, 2032, 2100, 2099, 2090, 2077]),
        ("Scales", [2058, 2057, 2079, 2062, 2063, 2076, 2076, 2072]),
    ],
    "ep10x": [
        ("AScales", [2047, 2025, 2063, 2034, 2022, 2054, 2024, 2033]),
        ("Scales", [2069, 2057, 2062, 2059, 2066, 2070, 2072, 2070]),
    ],
    "ep11": [
        ("AScales", [2076, 2067, 2050, 2069, 2083, 2091, 2095, 2081]),
        ("Scales", [2061, 2052, 2053, 2066, 2053, 2056, 2064, 2080]),
    ],
    "ep12": [
        ("AScales", [2039, 2018, 2056, 2049, 2046, 2107, 2076, 2062]),
        ("Scales", [2062, 2074, 2077, 2051, 2073, 2079, 2076, 2064]),
    ],
    "ep13": [
        ("AScales", [2081, 2073, 2087, 2075, 2063, 2123, 2091, 2117]),
        ("Scales", [2072, 2075, 2072, 2082, 2078, 2072, 2075, 2082]),
    ],
    "ep14": [
        ("AScales", [2094, 2107, 2105, 2071, 2070, 2060, 2090, 2083]),
        ("Scales", [2075, 2071, 2064, 2077, 2066, 2071, 2075, 2081]),
    ],
    "ep15x": [
        ("AScales", [2067, 2064, 2059, 2055, 2080, 2047, 2056, 2056]),
        ("Scales", [2070, 2070, 2076, 2086, 2083, 2074, 2077, 2061]),
    ],
    "ep16": [
        ("AScales", [2112, 2095, 2100, 2099, 2089, 2119, 2129, 2154]),
        ("Scales", [2230, 2253, 2242, 2235, 2229, 2244, 2247, 2249]),
    ],
    "ep17": [
        ("AScales", [2129, 2069, 2045, 2103, 2038, 2065, 2121, 2063]),
        ("Scales", [2239, 2241, 2241, 2233, 2240, 2247, 2260, 2253]),
    ],
    "ep18": [
        ("AScales", [2119, 2073, 2111, 2121, 2104, 2097, 2121, 2113]),
        ("Scales", [2243, 2221, 2254, 2235, 2223, 2256, 2255, 2260]),
    ],
}
