...
watch_conditions = [
    ...
    dict(
        condition='det_kwscounting and shutter_value != "open"',
    ...
    dict(
        condition='det_kwscounting and (sixfold_shutter_value != "open" or '
    ...
    dict(
        condition="det_kwscounting and (chopper1_freq_status[0] == WARN or "
    ...
    dict(
        condition="det_kwscounting and abs(b_ccm3a_value - b_ccm3a_readback_value) > 0.2",
