...
devices = dict(
    ...
    doppler=device(
        "nicos_mlz.spheres.devices.doppler.Doppler",
        ...
        fallback="undefinded",
        pollinterval=5,
        margins=dict(speed=0.01, amplitude=0.1),
    ),
    acqdoppler=device(
        "nicos_mlz.spheres.devices.doppler.AcqDoppler",
