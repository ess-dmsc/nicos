...
devices = dict(
    ...
    #                 ),
    events=device(
        "nicos.devices.vendor.qmesydaq.taco.Counter",
        description="QMesyDAQ Events channel",
        tacodevice=qm + "events",
        type="counter",
    ),
    mesyimg=device(
        "nicos.devices.vendor.qmesydaq.taco.Image",
    ...
    mesylive=device(
        "nicos_mlz.spheres.devices.mesydaqdatasink." "SpheresMesydaqLiveViewSink",
        description="Sends image data to LiveViewWidget",
        detectors=["mesy"],
    ),
    mesysink=device(
        "nicos_mlz.spheres.devices.mesydaqdatasink." "SpheresMesydaqImageSink",
    ...
    mesytimer=device(
        "nicos_mlz.spheres.devices.mesydaq.Timer",
