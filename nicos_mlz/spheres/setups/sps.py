...
analogs = dict(
    ...
    dop_tmp_L_i=dict(
        desc="doppler left motor water in temperature", unit="deg C", vis=()
    ),
    dop_tmp_L_f=dict(
        desc="doppler left motor water out temperature", unit="deg C", vis=()
    ),
    dop_tmp_R_mot=dict(desc="doppler right motor temperature", unit="deg C", vis=()),
    dop_tmp_R_i=dict(
        desc="doppler right motor water in temperature", unit="deg C", vis=()
    ),
    dop_tmp_R_f=dict(
        desc="doppler right motor water out temperature", unit="deg C", vis=()
    ),
...
digitals = dict(
    ...
    housing_tmp_alert=dict(
        mapping=6, desc="housing temperature alert", unit="", vis=()
    ),
    ...
    housing_chain3_open=dict(
        mapping=0, desc="housing chain stairs open", unit="", vis=()
    ),
    ...
    argon_Pin_argon_alert=dict(
        mapping=6, desc="PI2: argon supply underpressure", unit="", vis=()
    ),
    argon_Pin_air_alert=dict(
        mapping=6, desc="PI3: air supply underpressure", unit="", vis=()
    ),
...
background = dict(
    ...
    offset=dict(
        desc="backgroundchopper offset to pst", limits=None, unit="deg", vis=vis
    ),
    spm1=dict(
        desc="backgroundchopper primary bearing force", limits=None, unit="mg", vis=()
    ),
    spm2=dict(
        desc="backgroundchopper primary bearing force", limits=None, unit="mg", vis=()
    ),
    temperature=dict(
        desc="backgroundchopper temperature", limits=None, unit="deg C", vis=()
    ),
