...
devices = dict(
    cct6_c_temperature=device(
        "nicos_mlz.spheres.devices.sample.SEController",
    ...
    cct6_T_sample=device(
        "nicos_mlz.spheres.devices.sample.TemperatureController",
    ...
    cct6_v_flood=device(
        ...
        description="Valve to flood the sample environment " "with exchangegas",
    ...
    cct6_c_pressure=device(
        "nicos_mlz.spheres.devices.sample.PressureController",
