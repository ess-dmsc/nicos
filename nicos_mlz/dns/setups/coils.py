...
zero = (0, 0.095, -0.45, -2.27, -2.27, (0, 0), "off")
#  with spin flipper
zero_sf = (0, 0.095, -0.45, -2.27, -2.27, (-0.95, -0.35), "on")
...
# z
z7_sf = (0, 0.095, -0.45, 0.0, 0.0, (-0.80, -0.45), "on")
z20_sf = (0, 0.095, -0.45, 0.0, 0.0, (-0.9, -0.53), "on")
mz7_sf = (0, 0.095, -0.45, -1, -1, (-0.9, -0.5), "on")
z7_high_sf = (0, 0.095, -0.45, 5.0, 5.0, (-0.925, -0.35), "on")
...
devices = dict(
    flipper=device(
        "nicos.devices.polarized.flipper.MezeiFlipper",
        description="Neutron spin flipper",
        flip="Fi",
        corr="Co",
    ),
    flip_currents=device(
    ...
    #    ),
    field=device(
        "nicos_mlz.dns.devices.coils.MultiSwitcher",
