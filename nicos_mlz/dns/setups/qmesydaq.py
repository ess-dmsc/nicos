...
devices = dict(
    Histogram=device(
        "nicos_mlz.dns.devices.qmesydaqsinks.HistogramSink",
    ...
    Listmode=device(
        "nicos_mlz.dns.devices.qmesydaqsinks.ListmodeSink",
    ...
    qevents=device(
        "nicos_mlz.dns.devices.qmesydaqsinks.ImageCounterChannel",
    ...
    qm_det=device(
        "nicos_mlz.dns.devices.detector.DNSDetector",
