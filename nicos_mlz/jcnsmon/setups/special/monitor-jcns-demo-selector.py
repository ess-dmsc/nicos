...
_kws1selector = Block(
    ...
    [
        ...
        BlockRow(
            Field(name="Lambda", dev="kws1/selector_lambda"),
            Field(name="Speed", dev="kws1/selector_speed"),
        ),
        BlockRow(
            Field(name="Vac", dev="kws1/selector_vacuum"),
            Field(name="Rotor", dev="kws1/selector_rtemp"),
        ),
        BlockRow(
            Field(name="Flow", dev="kws1/selector_wflow"),
...
_kws2selector = Block(
    ...
    [
        ...
        BlockRow(
            Field(name="Lambda", dev="kws2/selector_lambda"),
            Field(name="Speed", dev="kws2/selector_speed"),
        ),
        BlockRow(
            Field(name="Vac", dev="kws2/selector_vacuum"),
            Field(name="Rotor", dev="kws2/selector_rtemp"),
        ),
        BlockRow(
            Field(name="Flow", dev="kws2/selector_wflow"),
            Field(name="Vibr", dev="kws2/selector_vibrt"),
        ),
    ],
)

_mariaselector = Block(
    "Selector MARIA",
    [
        BlockRow(
            Field(name="Lambda", dev="maria/selector_lambda"),
            Field(name="Speed", dev="maria/selector_speed"),
        ),
        BlockRow(
            Field(name="Vac", dev="maria/selector_vacuum"),
            Field(name="Rotor", dev="maria/selector_rtemp"),
        ),
        BlockRow(
            Field(name="Flow", dev="maria/selector_wflow"),
