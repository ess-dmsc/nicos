...
ccm3a_1 = Block(
    ...
    [
        ...
        BlockRow(
            Field(name="T1", dev="se/ccm3a_T1", unit="K"),
...
cct6_1 = Block(
    ...
    [
        ...
        "---",
        BlockRow(
            Field(name="tube SP", dev="se/cct6_T_tube/setpoint", unit="K"),
            Field(name="sample SP", dev="se/cct6_setpoint", unit="K"),
            Field(name="pressure", dev="se/cct6_c_pressure", unit="mbar"),
        ),
        BlockRow(
            Field(name="heater tube", dev="se/cct6_T_tube/heateroutput", unit="%"),
