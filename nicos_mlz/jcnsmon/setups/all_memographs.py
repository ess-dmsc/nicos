...
for instr in instrs:
    ...
    devices[instr + "_cooling_t_in"] = device(
    ...
    devices[instr + "_cooling_t_out"] = device(
        "nicos.devices.entangle.Sensor",
    ...
    devices[instr + "_cooling_p_in"] = device(
        "nicos.devices.entangle.Sensor",
    ...
    devices[instr + "_cooling_p_out"] = device(
        "nicos.devices.entangle.Sensor",
    ...
    devices[instr + "_cooling_flow_in"] = device(
        "nicos.devices.entangle.Sensor",
    ...
    devices[instr + "_cooling_flow_out"] = device(
        "nicos.devices.entangle.Sensor",
    ...
    devices[instr + "_cooling_leak"] = device(
        "nicos.devices.entangle.Sensor",
    ...
    devices[instr + "_cooling_power"] = device(
        "nicos.devices.entangle.Sensor",
