...
for i in range(1, 3):
    ...
    devices[f"s_cathode{i}_c"] = device(
        "nicos.devices.generic.ReadonlyParamDevice",
...
for i in range(1, 2):
    ...
    devices[f"s_banode{i}_c"] = device(
        "nicos.devices.generic.ReadonlyParamDevice",
