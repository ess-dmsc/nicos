...
devices = dict(
    ...
    b_hv=device(
        "nicos_mlz.erwin.devices.HVSwitch",
...
for i in range(1, 3):
    ...
    devices[f"b_cathode{i}_c"] = device(
        "nicos.devices.generic.ReadonlyParamDevice",
...
for i in range(1, 9):
    ...
    devices[f"b_banode{i}_c"] = device(
        "nicos.devices.generic.ReadonlyParamDevice",
