...
devices = dict(
    T_flex=device(
        "nicos_mlz.kws3.devices.temperature.FlexRegulator",
        ...
        configs={
            ...
            "julabo12-mawi1": (
                tango_base + "julabo12/control_int",
                (tango_base + "mawitherm/ch1", 10, 90, 30, 7, 2),
            ),
            "julabo12-mawimean": (
                tango_base + "julabo12/control_int",
                (tango_base + "mawitherm/mean", 10, 90, 30, 7, 2),
            ),
            "julabo22-intern": (tango_base + "julabo22/control_int", None),
            "julabo22-extern": (tango_base + "julabo22/control_ext", None),
            "julabo22-mawi1": (
                tango_base + "julabo22/control_int",
                (tango_base + "mawitherm/ch1", 10, 90, 30, 7, 2),
            ),
            "julabo22-mawimean": (
                tango_base + "julabo22/control_int",
    ...
    T_flex_config=device(
        "nicos_mlz.kws3.devices.temperature.ConfigParamDevice",
