...
devices = dict(
    yamlformat=device(
        "nicos_mlz.kws3.devices.yamlformat.YAMLFileSink",
        detectors=["det"],
    ...
    detector=device(
        "nicos_mlz.kws3.devices.daq.DetSwitcher",
    ...
    det_5x5max=device(
        "nicos_mlz.kws3.devices.daq.ConvolutionMax",
        visibility=(),
    ),
    det_roi=device(
        "nicos_mlz.kws3.devices.daq.ROIChannel",
