...
main_window = tabbed(
    ...
    (
        "Tunewave table",
        panel(
            "nicos_mlz.gui.tunewavetable.TunewaveTablePanel",
            tabledev="echotime",
            measuremode="mieze",
            setups="tuning",
        ),
    ...
    (
        "Mieze display",
        panel(
            "nicos_mlz.reseda.gui.mieze_display.MiezePanel",
            foils=[0, 1, 2, 5, 6, 7],
            setups="mieze",
        ),
    ),
...
windows = [
    ...
    window(
        ...
        "live",
        panel(
            "nicos_mlz.reseda.gui.live.CascadeLiveDataPanel",
            filetypes=["pad", "tof"],
    ...
    window("Devices", "table", panel("nicos.clients.gui.panels.devices.DevicesPanel")),
