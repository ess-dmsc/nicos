...
_column1 = Column(
    ...
    Block(
        ...
        [
            BlockRow(
                Field(
                    widget="nicos.guisupport.tas.TasWidget",
                    width=30,
                    height=18,
                    mthdev="m2th",
                    mttdev="m2tt",
    ...
    SetupBlock("miramagnet"),
    SetupBlock("miramagnet", "temperatures"),
    SetupBlock("amagnet"),
    SetupBlock("ccm5v5"),
    SetupBlock("ccm5v5", "temperatures"),
    SetupBlock("ccm5h"),
    SetupBlock("ccm5h", "temperatures"),
    SetupBlock("ccm2a2"),
    SetupBlock("ccm2a2", "temperatures"),
    Block(
        "12T Magnet",
        [
            BlockRow(
...
_column2 = Column(
    ...
    Block(
        ...
        [
            BlockRow(
                Field(
                    name="Setpoint", key="t/setpoint", unitkey="t/unit", format="%.2f"
                ),
    ...
    Block(
        ...
        [
            BlockRow(
                Field(
                    name="Setpoint",
                    key="t_htf20/setpoint",
                    unitkey="t_htf20/unit",
                    format="%.2f",
                ),
    ...
    SetupBlock("cci3he01"),
    SetupBlock("cci3he01", "pressures"),
    SetupBlock("cci3he02"),
    SetupBlock("cci3he02", "pressures"),
    SetupBlock("cci3he03"),
    SetupBlock("cci3he03", "pressures"),
    SetupBlock("cci3he10"),
    SetupBlock("cci3he10", "pressures"),
    SetupBlock("cci3he11"),
    SetupBlock("cci3he11", "pressures"),
    SetupBlock("cci3he12"),
    SetupBlock("cci3he12", "pressures"),
    SetupBlock("ccidu01"),
    SetupBlock("ccidu01", "pressures"),
    SetupBlock("ccidu02"),
    SetupBlock("ccidu02", "pressures"),
    Block(
        "Humidity Julabo",
        [
            BlockRow(
