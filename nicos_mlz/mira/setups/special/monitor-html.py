    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(name="Title", key="exp/title", width=15, istext=True, maxlen=15),
                Field(
                    name="Sample",
                ...
                Field(
                    name="Remark", key="exp/remark", width=30, istext=True, maxlen=30
                ),
...
_column2 = Column(
    ...
    Block(
        ...
        [
            ...
            BlockRow(
                Field(name="P", key="t_ccr11/p"),
                Field(name="I", key="t_ccr11/i"),
                Field(name="D", key="t_ccr11/d"),
