...
_column1 = Column(
    Block(
        ...
        [
            BlockRow(
                Field(name="Setpoint", key="T_ccr_tube/setpoint", unitkey="T/unit"),
                Field(name="Target", key="T_ccr_tube/target", unitkey="T/unit"),
            ),
            BlockRow(
                Field(
                    name="Manual Heater Power Stick",
                    key="T_ccr_stick/heateroutput",
                    format="%.3f",
                    unitkey="T/unit",
                ),
            ),
    ...
    Block(
        ...
        [
            BlockRow(
                Field(
                    name="Live data",
                    picture="reseda-online/live.png",
                    refresh=1,
                    width=24,
                    height=24,
                ),
        ...
        Block(
            ...
            [
                ...
                BlockRow(
                    ...
                    Field(
                        name="Contrast ROI", key="psd/value[4]", format="%.2f", width=9
                    ),
                ),
                BlockRow(
                    Field(name="cts total", key="psd/value[3]", format="%.0f", width=9),
                    Field(
                        name="Contrast total",
                        key="psd/value[8]",
                        format="%.2f",
