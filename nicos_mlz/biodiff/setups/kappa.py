...
devices = dict(
    ...
    omega_minikappa_m=device(
        "nicos_mlz.biodiff.devices.motor.MicrostepMotor",
        description="Mini-kappa omega axis (micro)",
        motor="omega_minikappa",
        precision=0.001,
        abslimits=(-390, 390),
    ),
    omega_minikappa_cod=device(
