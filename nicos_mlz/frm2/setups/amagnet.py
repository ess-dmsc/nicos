...
devices = dict(
    ...
    amagnet_symmetry=device(
        ...
        mapping=dict(symmetric=1, short=0, unsymmetric=-1),
        unit="",
    ),
    I_amagnet=device(
    ...
    B_amagnet=device(
        "nicos_mlz.devices.amagnet.GarfieldMagnet",
        ...
        calibrationtable=dict(
            ...
            unsymmetric=(0.00136154, 0.027454, -0.120951, 0.0495289, 0.110689),
        ),
