...
devices = {
    ...
    f"T_{setupname}_sample_stick": device(
        "nicos.devices.entangle.Sensor",
    ...
    f"T_{setupname}_coldhead": device(
        "nicos.devices.entangle.Sensor",
    ...
    f"T_{setupname}_sample_tube": device(
        "nicos.devices.entangle.Sensor",
    ...
    f"{setupname}_compressor": device(
        "nicos.devices.entangle.NamedDigitalOutput",
...
alias_config = {
    ...
    "Ts": {
        f"T_{setupname}_sample_stick": 100,
        f"T_{setupname}_sample_tube": 90,
        f"T_{setupname}_still": 20,
        f"T_{setupname}_coldhead": 10,
    },
}
...
monitor_blocks = dict(
    default=Block(
        ...
        [
            BlockRow(
                Field(
                    key=f"t_{setupname}/setpoint",
                    unitkey=f"t_{setupname}/unit",
                    name="Setpoint",
                    width=12,
                ),
                Field(
                    key=f"t_{setupname}/target",
                    unitkey=f"t_{setupname}/unit",
                    name="Target",
                    width=12,
                ),
            ...
            BlockRow(
                Field(
                    name="Manual Heater Power Stick",
                    key=f"t_{setupname}_stick/heaterpower",
                    format="%.3f",
                    unitkey="t/unit",
                ),
            ),
            BlockRow(
                Field(
                    name="Manual Heater Power Tube",
                    key=f"t_{setupname}_tube/heaterpower",
                    format="%.3f",
                    unitkey="t/unit",
                ),
            ),
