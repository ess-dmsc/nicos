...
devices = {
    ...
    f"T_{setupname}_pot_heaterrange": device(
    ...
    f"T_{setupname}_sample2": device(
        "nicos.devices.entangle.Sensor",
...
monitor_blocks = dict(
    default=Block(
        "3He insert " + setupname,
        [
            BlockRow(
                Field(
                    name="Setpoint", key=f"t_{setupname}_pot/setpoint", unitkey="t/unit"
                ),
                Field(name="Target", key=f"t_{setupname}_pot/target", unitkey="t/unit"),
            ),
            BlockRow(
                Field(name="Pot", dev=f"T_{setupname}_pot"),
                Field(
                    name="Manual Heater Power",
                    key=f"t_{setupname}_pot/heaterpower",
                    unitkey="t/unit",
                ),
            ),
            BlockRow(
