...
devices = {
    ...
    f"T_{setupname}_heater_range": device(
    ...
    f"{setupname}_still_heater": device(
    ...
    f"{setupname}_warm_up_heater": device(
        "nicos.devices.entangle.AnalogOutput",
...
for i in [1, 2, 3, 5]:
    devices[f"{setupname}_p{i}"] = device(
        "nicos.devices.entangle.Sensor",
