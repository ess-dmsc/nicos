...
devices = {
    ...
    f"{setupname}_waterflow": device(
        ...
        warnlimits=(
            1.5,
            25,
        ),  # HW will switch off below 1 l/s, sensor saturates at 30 l/s
    ),
