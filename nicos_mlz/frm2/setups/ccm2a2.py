...
devices = {
    ...
    f"B_{setupname}_readback": device(
    ...
    f"{setupname}_waterflow": device(
        "nicos_mlz.devices.ccmhts.WaterFlow",
    ...
    f"{setupname}_T1": device(
        "nicos.devices.entangle.AnalogInput",
        description="Temperature of the first stage of the " "cryo-cooler",
        tangodevice=tango_base + "hts_mss/t1",
        unit="K",
        warnlimits=(0, 44),
    ),
    f"{setupname}_T2": device(
        "nicos.devices.entangle.AnalogInput",
        description="Temperature of the second stage of the " "cryo-cooler",
        tangodevice=tango_base + "hts_mss/t2",
        unit="K",
        warnlimits=(0, 12),
    ),
    f"{setupname}_TA": device(
        "nicos.devices.entangle.AnalogInput",
