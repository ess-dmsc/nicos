...
devices = dict(
    ...
    orca_camera=device(
        ...
        topic_pv=f"{camera_system_pv_root}{camera_kafkaplugin_pv_root}KafkaTopic_RBV",
        source_pv=f"{camera_system_pv_root}{camera_schemasplugin_pv_root}SourceName_RBV",
        unit="images",
        pva=True,
        monitor=True,
        pollinterval=0.5,
