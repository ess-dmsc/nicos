...
devices = dict(
    ...
    pinhole_1_hori_centre=device(
        "nicos_ess.devices.epics.pva.motor.EpicsMotor",
        description="Pinhole Slit 1 horizontal centre (Yc)",
        motorpv="ODIN-PinSl1:MC-Yc-01:Mtr",
        monitor_deadband=0.01,
    ),
    pinhole_1_hori_gap=device(
        "nicos_ess.devices.epics.pva.motor.EpicsMotor",
        description="Pinhole Slit 1 horizontal gap (Yg)",
        motorpv="ODIN-PinSl1:MC-Yg-01:Mtr",
        monitor_deadband=0.01,
    ),
    pinhole_1_vert_centre=device(
        "nicos_ess.devices.epics.pva.motor.EpicsMotor",
        description="Pinhole Slit 1 vertical centre (Zc)",
        motorpv="ODIN-PinSl1:MC-Zc-01:Mtr",
        monitor_deadband=0.01,
    ),
    pinhole_1_vert_gap=device(
        "nicos_ess.devices.epics.pva.motor.EpicsMotor",
        description="Pinhole Slit 1 vertical gap (Zg)",
        motorpv="ODIN-PinSl1:MC-Zg-01:Mtr",
        monitor_deadband=0.01,
    ),
    # --- Motors: Pinhole slit set 2 (blades + centre & gap) ---
    pinhole_2_yp=device(
        "nicos_ess.devices.epics.pva.motor.EpicsMotor",
    ...
    pinhole_2_hori_centre=device(
        "nicos_ess.devices.epics.pva.motor.EpicsMotor",
        description="Pinhole Slit 2 horizontal centre (Yc)",
        motorpv="ODIN-PinSl2:MC-Yc-01:Mtr",
        monitor_deadband=0.01,
    ),
    pinhole_2_hori_gap=device(
        "nicos_ess.devices.epics.pva.motor.EpicsMotor",
        description="Pinhole Slit 2 horizontal gap (Yg)",
        motorpv="ODIN-PinSl2:MC-Yg-01:Mtr",
        monitor_deadband=0.01,
    ),
    pinhole_2_vert_centre=device(
        "nicos_ess.devices.epics.pva.motor.EpicsMotor",
        description="Pinhole Slit 2 vertical centre (Zc)",
        motorpv="ODIN-PinSl2:MC-Zc-01:Mtr",
        monitor_deadband=0.01,
    ),
    pinhole_2_vert_gap=device(
        "nicos_ess.devices.epics.pva.motor.EpicsMotor",
        description="Pinhole Slit 2 vertical gap (Zg)",
        motorpv="ODIN-PinSl2:MC-Zg-01:Mtr",
        monitor_deadband=0.01,
    ),
    # --- Cabinet health ---
