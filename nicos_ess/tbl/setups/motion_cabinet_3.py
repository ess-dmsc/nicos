...
devices = dict(
    ...
    mc_pne_315=device(
        ...
        closingpv="TBL-TBL:MC-Pne-315:ShtStatusBits.B1",
        openingpv="TBL-TBL:MC-Pne-315:ShtStatusBits.B2",
        msgtxt="TBL-TBL:MC-Pne-315:ShtMsgTxt",
        resetpv="TBL-TBL:MC-Pne-315:ShtErrRst",
        pva=True,
        monitor=True,
        pollinterval=0.5,
        maxage=None,
    ...
    mc_pne_316=device(
        ...
        closingpv="TBL-TBL:MC-Pne-316:ShtStatusBits.B1",
        openingpv="TBL-TBL:MC-Pne-316:ShtStatusBits.B2",
        msgtxt="TBL-TBL:MC-Pne-316:ShtMsgTxt",
        resetpv="TBL-TBL:MC-Pne-316:ShtErrRst",
        pva=True,
        monitor=True,
        pollinterval=0.5,
        maxage=None,
