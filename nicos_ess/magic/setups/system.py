...
devices = dict(
    ...
    KafkaForwarder=device(
        ...
        statustopic=["magic_forwarder_dynamic_status"],
        config_topic="magic_forwarder_dynamic_config",
    ...
    FileWriterStatus=device(
        ...
        brokers=configdata("config.KAFKA_BROKERS"),
        statustopic=["magic_filewriter", "ess_filewriter_status"],
        unit="",
    ),
    FileWriterControl=device(
        ...
        instrument_topic="magic_filewriter",
