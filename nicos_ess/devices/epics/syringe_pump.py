...
class SyringePumpController(EpicsDeviceBase, MappedMoveable):
    ...
    _epics_channels = {
        ...
        "start": EpicsChannelInfo(
            "", "", EpicsChannelRole.VALUE, pv_attr="start_pv", subscribe=False
        ),
        "stop": EpicsChannelInfo(
            "", "", EpicsChannelRole.VALUE, pv_attr="stop_pv", subscribe=False
        ),
        "purge": EpicsChannelInfo(
            "", "", EpicsChannelRole.VALUE, pv_attr="purge_pv", subscribe=False
        ),
        "pause": EpicsChannelInfo(
            "", "", EpicsChannelRole.VALUE, pv_attr="pause_pv", subscribe=False
        ),
    }
