...
STREAMS = [
    StreamInfo(pv_root + "RotSpeed-R", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "Strain1-R", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "ShearStrain", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "ShearStress", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "ShearRate", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "Torque-R", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "PhaseAng-R", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "Viscosity", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "TotModulus", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "CSRfactor", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "CSSfactor", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "Temp-R", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "Viscosity", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "TotModulus", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "MeasNumb-R", "f144", "se_lab_devices", Protocol.Protocol.PVA),
    StreamInfo(pv_root + "MeasInterval-R", "f144", "se_lab_devices", Protocol.Protocol.PVA),
]
