...
class AreaDetector(ImageChannelMixin, EpicsDevice, ActiveChannel):
    ...
    def _set_custom_record_fields(self):
        ...
        self._record_fields["image_pv"] = "test"
...
class OrcaFlash4(AreaDetector):
    ...
    def doPreinit(self, mode):
        ...
        self._record_fields = {
            key + "_rbv": value + "_RBV" for key, value in self._control_pvs.items() #come back here
        }
        self._record_fields.update(self._control_pvs)
        AreaDetector._set_custom_record_fields(self)
        EpicsDevice.doPreinit(self, mode)
    ...
    def doPrepare(self):
        ...
        # Set up external trigger #come back here
...
########come back here: For the rest of these, should I just remove them????
