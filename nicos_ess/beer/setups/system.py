...
devices = dict(
    BEER=device(
        ...
        instrument="BEER",
        responsible="Premek Beran <premysl.beran@ess.eu>",
        website="https://europeanspallationsource.se/instruments/beer",
    ),
    Sample=device(
    ...
    KafkaForwarderStatus=device(
        ...
        statustopic=["beer_forwarder_dynamic_status"],
        config_topic="beer_forwarder_dynamic_config",
    ...
    FileWriterStatus=device(
        ...
        brokers=configdata("config.KAFKA_BROKERS"),
        statustopic=["beer_filewriter", "ess_filewriter_status"],
        unit="",
    ),
    FileWriterControl=device(
        ...
        instrument_topic="beer_filewriter",
