...
devices = dict(
    ...
    t0_chopper=device(
        ...
        total_delay="t0_chopper_total_delay",
        park_angle="t0_chopper_park_angle",
        delay_errors="t0_chopper_delay_errors",
        ...
        tdc_resolver_position=268.0,
        park_open_angle=178.0,
        disk_delay=0.0,
    ),
    ...
    band_chopper=device(
        ...
        total_delay="band_chopper_total_delay",
        park_angle="band_chopper_park_angle",
        delay_errors="band_chopper_delay_errors",
    ...
    overlap_chopper=device(
        ...
        total_delay="overlap_chopper_total_delay",
        park_angle="overlap_chopper_park_angle",
        delay_errors="overlap_chopper_delay_errors",
