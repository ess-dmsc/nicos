...
devices = dict(
    ...
    wls1_phase=device(
        ...
        phase_ns_dev="wls1_delay",
        mapped_speed_dev="wls1_speed",
        offset=0,
        unit="degrees",
    ),
    wls1_delay_errors=device(
