...
devices = dict(
    ...
    wls2b_phase=device(
        ...
        phase_ns_dev="wls2b_delay",
        mapped_speed_dev="wls2b_speed",
        offset=0,
        unit="degrees",
    ),
    wls2b_delay_errors=device(
    ...
    wls2b_chopper=device(
        ...
        maxage=None,
        state="wls2b_status",
        command="wls2b_control",
        speed="wls2b_speed",
        chic_conn="wls2b_chic",
        alarms="wls2b_alarms",
        slit_edges=[[0, 170]],
