...
devices = dict(
    ...
    sg1_pt100_01=device(
        ...
        description="Vacuum Vessel Pt100 Sensor 01",
        readpv=f"{sg1_pt_root}01:Temp",
        visibility=(),
    ),
    sg1_pt100_02=device(
        "nicos_ess.devices.epics.pva.EpicsStringReadable",
        description="Vacuum Vessel Pt100 Sensor 02",
        readpv=f"{sg1_pt_root}02:Temp",
        visibility=(),
    ),
    sg1_pt100_03=device(
        "nicos_ess.devices.epics.pva.EpicsStringReadable",
        description="Vacuum Vessel Pt100 Sensor 03",
        readpv=f"{sg1_pt_root}03:Temp",
        visibility=(),
    ),
    sg1_pt100_04=device(
        "nicos_ess.devices.epics.pva.EpicsStringReadable",
        description="Vacuum Vessel Pt100 Sensor 04",
        readpv=f"{sg1_pt_root}04:Temp",
        visibility=(),
    ),
    sg1_pt100_05=device(
        "nicos_ess.devices.epics.pva.EpicsStringReadable",
        description="Vacuum Vessel Pt100 Sensor 05",
        readpv=f"{sg1_pt_root}05:Temp",
        visibility=(),
    ),
    sg1_pt100_06=device(
        "nicos_ess.devices.epics.pva.EpicsStringReadable",
        description="Vacuum Vessel Pt100 Sensor 06",
        readpv=f"{sg1_pt_root}06:Temp",
        visibility=(),
    ),
    sg1_pt100_07=device(
        "nicos_ess.devices.epics.pva.EpicsStringReadable",
        description="Vacuum Vessel Pt100 Sensor 07",
        readpv=f"{sg1_pt_root}07:Temp",
        visibility=(),
    ),
    sg1_pt100_08=device(
        "nicos_ess.devices.epics.pva.EpicsStringReadable",
        description="Vacuum Vessel Top in Air",
    ...
    sg1_pt100_11=device(
        "nicos_ess.devices.epics.pva.EpicsStringReadable",
        description="Reference in Vacuum Base Plate",
