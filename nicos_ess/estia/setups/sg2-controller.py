...
devices = dict(
    sr2=device(
        ...
        adjust1="sg2_screwdriver_adjust_1",
        approach1="sg2_screwdriver_approach_1",
        hex_state1="sg2_screwdriver_hex_state_1",
        adjust2="sg2_screwdriver_adjust_2",
        approach2="sg2_screwdriver_approach_2",
        hex_state2="sg2_screwdriver_hex_state_2",
