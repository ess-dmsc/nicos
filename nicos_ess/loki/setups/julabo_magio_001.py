...
devices = dict(
    ...
    julabo_001_internal_temperature=device(
    ...
    julabo_001_external_temperature=device(
    ...
    julabo_001_external_enabled=device(
        "nicos_ess.devices.epics.pva.EpicsMappedMoveable",
    ...
    # Temp limits
    julabo_001_temperature_high_limit=device(
        "nicos_ess.devices.epics.pva.EpicsAnalogMoveable",
    ...
    julabo_001_temperature_low_limit=device(
        "nicos_ess.devices.epics.pva.EpicsAnalogMoveable",
    ...
    # Slope
    julabo_001_internal_slope=device(
        "nicos_ess.devices.epics.pva.EpicsReadable",
