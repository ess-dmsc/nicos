...
class SamplePanelWidgets(QWidget):
    def __init__(self):
        ...
        self.label_warning = QLabel("Changes to the samples have not been applied!")
        self.btn_apply = QPushButton("Apply")
        self.btn_discard = QPushButton("Discard")
        self.label_warning.setStyleSheet("font-weight: bold;" "color: red;")
        self.btn_apply.setFixedWidth(80)
        self.btn_discard.setFixedWidth(80)
        self.bottom_button_layout.addStretch()
        self.bottom_button_layout.addWidget(self.label_warning)
        self.bottom_button_layout.addWidget(self.btn_apply)
        self.bottom_button_layout.addWidget(self.btn_discard)
        ...
        panel_header.setStyleSheet(
            "font-size: 20pt;" "font-weight: 50;" "padding-top: 20px;"
        )
