...
class ScansPanel(PlotPanel):
    ...
    * ``fit_functions`` (default {}) -- dictionary for special fitting
    ...
    def __init__(self, parent, client, options):
        ...
        loadUi(self, findResource('nicos_ess/gui/panels/ui_files/scans.ui'))
    ...
    def createPanelToolbar(self):
        ...
        self.showToolText(bar, self.actionSavePlot)
        bar.addAction(self.actionPrint)
        self.showToolText(bar, self.actionPrint)
        bar.addSeparator()
        ...
        self.showToolText(bar, self.actionUnzoom)
        bar.addSeparator()
    ...
    def showToolText(self, toolbar, action):
