...
STUBS = dict(
    ...
    tango=[
        ...
        "exception CommunicationFailed",
        "exception WrongNameSyntax",
        "exception DevFailed",
        "exception NonDbDevice",
        "exception WrongData",
        "exception NonSupportedFeature",
        "exception AsynCall",
        "exception AsynReplyNotArrived",
        "exception EventSystemFailed",
        "exception DeviceUnlocked",
