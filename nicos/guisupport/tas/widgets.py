...
from nicos.guisupport.elements import (
    AnaTable,
    Beam,
    DetTable,
    MonoTable,
...
class TasView(QGraphicsView):
    ...
    def initUi(self):
        scene = self.scene
        self._mono = MonoTable(0.0, 0, self.monoradius, scene=scene)
    ...
    def update(self):
        ...
        self._sample.setRotation(sth - mtt + 45.0)
