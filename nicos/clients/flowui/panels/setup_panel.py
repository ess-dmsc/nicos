...
class ExpPanel(DefaultExpPanel):
    ...
    * ``new_exp_panel`` -- class name of the panel which should be opened after
    ...
    def _update_settings(self):
        self._old_settings["notifications"] = self.notifEmails.toPlainText().strip()
        self._old_settings["data_emails"] = self.dataEmails.toPlainText().strip()
        ...
        self._old_settings["abort"] = (
            "abort" if self.errorAbortBox.isChecked() else "report"
        )
    ...
    def on_queryDBButton_clicked(self):
        ...
        try:
            ...
            self.showError("Querying proposal management system failed: " + str(e))
