...
for i in range(1, 3):
    devices["chopper_ch%i_gear" % i] = device(
        "nicos.devices.generic.ManualMove",
    ...
    devices["chopper_ch%i_phase" % i] = device(
        "nicos.devices.generic.ManualMove",
    ...
    devices["chopper_ch%i_parkingpos" % i] = device(
        "nicos.devices.generic.ManualMove",
    ...
    devices["chopper_ch%i_speed" % i] = device(
        "nicos.devices.generic.ManualMove",
