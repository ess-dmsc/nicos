    ...
    cryos.append(
        Block(
            ...
            [
                BlockRow(
                    Field(
                        name="Setpoint", key="t_%s/setpoint" % cryo, unitkey="t/unit"
                    ),
                    Field(
                        name="Manual Heater Power",
                        key="t_%s/heaterpower" % cryo,
                        unitkey="t/unit",
                    ),
                ),
                BlockRow(
    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(
                    plot="julabo 30min", name="T extern 30min", dev="T_julabo_extern"
                ),
                Field(
                    plot="julabo 12h",
                    name="T intern 12h",
...
_live = Column(
    Block(
        ...
        [
            BlockRow(
                Field(name="Data (lin)", picture="live_lin.png", width=64, height=64),
                Field(name="Data (log)", picture="live_log.png", width=64, height=64),
            ),
        ],
    ),
)
