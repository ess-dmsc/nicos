...
_slitblock = Block(
    ...
    [
        ...
        BlockRow(
            Field(dev="ss.height", name="Height"), Field(dev="ss.width", name="Width")
        ),
    ],
    setups="tas",
)
...
_sansblock = Block(
    ...
    [
        BlockRow(
            ...
            #       height=10)),
            Field(
                devices=["det_pos1", "det_pos1_x", "det_pos1_tilt", "det_pos2"],
