...
devices = dict(
    ...
    coll=device(
        ...
        moveable="coll_m",
        mapping={"off": 0, "10m": 2, "15m": 4, "20m": 8},
        precision=0,
    ),
    st1_x=device(
        "nicos.devices.generic.VirtualMotor",
    ...
    BerSANSImageSink=device(
        "nicos_mlz.sans1.datasinks.BerSANSImageSink",
    ...
    det=device(
        "nicos.devices.generic.GatedDetector",
        description="demo 2D detector",
        timers=["det1_timer"],
    ...
    scandet=device(
        "nicos.devices.generic.VirtualScanningDetector",
