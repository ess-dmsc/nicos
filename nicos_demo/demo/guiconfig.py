        ...
        panel(
            ...
            sample_panel=tabbed(
                ...
                (
                    "TAS sample",
                    panel(
                        "nicos.clients.gui.panels.setup_panel.TasSamplePanel",
                        setups="tas",
                    ),
                ),
                (
                    "SXTAL sample",
                    panel(
                        "nicos.clients.gui.panels.setup_panel.SXTalSamplePanel",
                        setups="sxtal",
                    ),
                ),
            ),
...
windows = [
    ...
    window(
        "Watchdog", "errors", panel("nicos.clients.gui.panels.watchdog.WatchdogPanel")
    ),
]
