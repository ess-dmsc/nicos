    ...
    Block(
        ...
        [
            BlockRow(
                ...
                Field(name="Title", key="exp/title", width=60, istext=True, maxlen=60),
...
_detectorblock = Block(
    ...
    [
        BlockRow(
            ...
            Field(
                name="Preset", key="mon1/preselection"
            ),  #'mon1/value'/'mon1/preselection'*'det2/value' 'mon1/preselection'
