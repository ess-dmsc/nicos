...
main_window = docked(
    tabbed(
        (
            "PGAA",
            panel(
                "nicos_mlz.pgaa.gui.panels.PGAAPanel",
                setups="pgaa",
            ),
        ),
        (
            "Tomography",
            panel(
                "nicos_mlz.pgaa.gui.panels.TomographyPanel",
                setups="tomography",
            ),
        ),
        (
            "PGAI",
            panel(
                "nicos_mlz.pgaa.gui.panels.PGAIPanel",
                setups="pgai",
            ),
        ),
        (
...
windows = [
    ...
    window(
        ...
        "live",
        panel(
            "nicos.clients.gui.panels.live.ImagingLiveDataPanel",
            filetypes=["fits"],
        ),
        setups="tomo",
    ),
    window(
        "Live data",
        "live",
        panel("nicos.clients.gui.panels.live.LiveDataPanel", xscale="decimal"),
