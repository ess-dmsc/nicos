...
devices = dict(
    sans2d=device(
        "nicos_demo.mantid.devices.instrument.ViewableInstrument",
    ...
    sample=device(
        "nicos_mlz.sans1.devices.sample.Sample",
    ...
    mantid_move_det=device(
        "nicos_demo.mantid.devices.devices.MantidTranslationDevice",
        args={"RelativePosition": False, "ComponentName": "front-detector"},
        x="mot_x",
        z="mot_z",
        visibility=(),
    ),
    mantid_rot_det=device(
        "nicos_demo.mantid.devices.devices.MantidRotationDevice",
        args={"RelativeRotation": False, "ComponentName": "front-detector"},
        y=1,
        angle="mot_omega",
        visibility=(),
    ),
