...
hrpt_default = {
    ...
    "entry1:NXentry": {
        ...
        "proposal_title": DeviceDataset("Exp", "proposal_title"),
        ...
        "sample:NXsample": {
            ...
            "sample_rotation_state": DeviceDataset("som_oscillation"),
            "sample_mur": DeviceDataset("Sample", "mur"),
            "hugo": NexusSampleEnv(postfix="_log"),
            "temperature": OptionalDeviceDataset("temperature"),
            "magnetic_field": OptionalDeviceDataset("mf"),
            "temperature_mean": DevStat("temperature:avg"),
            "temperature_stddev": DevStat("temperature:stddev"),
        },
        "HRPT:NXinstrument": {
            "HRPT-CERCA-Detector:NXpsd": {
                ...
                "Step": ConstDataset(0.01, "float32"),
                "beam_monitor": DetectorDataset(
                    "monitor2", "int32", units=NXAttribute("counts", "string")
                ),
                "number_of_steps": ConstDataset(1600, "int32"),
                "proton_monitor": DetectorDataset(
                    "protoncount", dtype="int32", units=NXAttribute("counts", "string")
                ),
                "radial_collimator_status": DeviceDataset("racoll"),
                "radial_collimator_type": DeviceDataset("racoll", parameter="type"),
                "time": DetectorDataset("elapsedtime", "float32"),
                "two_theta_start": DeviceDataset("s2t", dtype="float32"),
                "two_theta": TwoThetaArray(
                    "s2t", 0.1, 1600, axis=NXAttribute(1, "int32")
                ),
                "counts": ImageDataset(0, 0, signal=NXAttribute(1, "int32")),
                "polar_angle": NXLink("/entry1/HRPT/HRPT-CERCA-Detector/two_theta"),
                "data": NXLink("/entry1/HRPT/HRPT-CERCA-Detector/counts"),
            },
            "Kollimator1:NXcollimator": {
                "kollimator1": DeviceDataset(
                    "cex1", units=NXAttribute("degrees", "string")
                ),
                "kollimator2": DeviceDataset(
                    "cex2", units=NXAttribute("degrees", "string")
                ),
            },
            "Monochromator:NXmonochromator": {
                "curvature_lower": DeviceDataset("mcvl"),
                "omega_lower": DeviceDataset(
                    "moml", units=NXAttribute("degree", "string")
                ),
                "paralell_tilt_lower": DeviceDataset("mgpl"),
                ...
                "lift": DeviceDataset("mexz", units=NXAttribute("mm", "string")),
                "lambda": DeviceDataset(
                    "wavelength",
                    dtype="float32",
