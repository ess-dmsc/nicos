...
devices = dict(
    vs_speed=device(
        "nicos_sinq.devices.velocity_selector.VSForbiddenMoveable",
    ...
    vs_tilt=device(
        "nicos_sinq.devices.velocity_selector.VSTiltMotor",
    ...
    vs_lambda=device(
        "nicos_sinq.devices.velocity_selector.VSLambda",
