...
sans_detector = {
    ...
    "x_pixel_size": ConstDataset(7.5, "float", units=NXAttribute("mm", "string")),
    "y_pixel_size": ConstDataset(7.5, "float", units=NXAttribute("mm", "string")),
    "polar_angle": ConstDataset(0, "float", units=NXAttribute("degree", "string")),
    "aequatorial_angle": ConstDataset(
        0, "float", units=NXAttribute("degree", "string")
    ),
    "azimuthal_angle": ConstDataset(0, "float", units=NXAttribute("degree", "string")),
    "rotation_angle": NXLink("/entry1/SANS/detector/chi_position"),
    "beam_center_x": ConstDataset(0, "float", units=NXAttribute("degree", "string")),
    "beam_center_y": ConstDataset(0, "float", units=NXAttribute("degree", "string")),
}
    ...
    "entry1:NXentry": {
        ...
        "SANS:NXinstrument": {
            ...
            "monochromator:NXmonochromator": {
                "wavelength": NXLink("/entry1/SANS/Dornier-VS/lambda"),
                "wavelength_spread": ConstDataset(0.1, "float"),
            },
            "SINQ:NXsource": {
            ...
            "collimator:NXcollimator": {
                ...
                "geometry:NXgeometry": {
                    "shape:NXshape": {
                        "shape": ConstDataset("nxcylinder", "string"),
                    },
                    "size": NXLink("/entry1/SANS/collimator/length"),
                },
            },
            "monitor1:NXmonitor": {
                "counts": DetectorDataset(
            ...
            "monitor3:NXmonitor": {
                "counts": DetectorDataset(
                    "monitor3", "int32", units=NXAttribute("counts", "string")
                ),
            },
            "monitor4:NXmonitor": {
                "counts": DetectorDataset(
                    "monitor4", "int32", units=NXAttribute("counts", "string")
                ),
            },
            "monitor_5:NXmonitor": {
                "counts": DetectorDataset(
                    "monitor5", "int32", units=NXAttribute("counts", "string")
                ),
            },
            "monitor_6:NXmonitor": {
                "counts": DetectorDataset(
                    "monitor6", "int32", units=NXAttribute("counts", "string")
                ),
            },
            "monitor_7:NXmonitor": {
                "counts": DetectorDataset(
                    "monitor7", "int32", units=NXAttribute("counts", "string")
                ),
            },
            "monitor_8:NXmonitor": {
                "counts": DetectorDataset(
                    "monitor8", "int32", units=NXAttribute("counts", "string")
                ),
            },
        ...
        "data1:NXdata": {
            ...
            "data": NXLink("/entry1/SANS/detector/counts"),
            "detector_x": NXLink("/entry1/SANS/detector/detector_x"),
            "detector_y": NXLink("/entry1/SANS/detector/detector_y"),
...
class SANSTemplateProvider(NexusTemplateProvider):
    def getTemplate(self):
        ...
        full["entry1:NXentry"]["SANS:NXinstrument"]["detector:NXdetector"] = deepcopy(
            sans_detector
        )
        if "sample" in session.loaded_setups:
            full["entry1:NXentry"]["sample:NXsample"] = dict(
                sample_common, **sample_std
            )
        elif "emagnet_sample" in session.loaded_setups:
            full["entry1:NXentry"]["sample:NXsample"] = dict(
                sample_common, **sample_magnet
            )
        else:
