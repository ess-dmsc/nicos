description = "This initializes EIGER for the UB matrix triple axis " "calculation"
...
devices = dict(
    ublist=device(
        ...
        reflection_list=[],
        column_headers=(("H", "K", "L"), ("A3", "A4", "SGU", "SGL"), ("EI", "EF")),
    ),
    Sample=device(
    ...
    EIGER=device(
        "nicos_sinq.sxtal.instrument.TASSXTal",
