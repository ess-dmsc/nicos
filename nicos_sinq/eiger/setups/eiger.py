...
devices = dict(
    ...
    sslit=device(
        ...
        description="Sample slilit with left, right, bottom and " "top motors",
        opmode="4blades",
        left="msl",
        right="msr",
        top="mst",
    ...
    a6=device(
        "nicos_sinq.eiger.devices.a6motor.A6Motor",
    ...
    ana=device(
        "nicos_sinq.devices.mono.TasAnalyser",
