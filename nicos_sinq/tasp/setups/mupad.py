...
devices = dict(
    ...
    gufi=device(
        "nicos_sinq.tasp.devices.gufi.GuideField",
        description="Guide field control",
        magnet="i7",
        hold_value=1.2,
    ),
    mupad=device(
        "nicos_sinq.tasp.devices.mupad.Mupad",
    ...
    musw=device(
        "nicos_sinq.tasp.devices.mupad.MuSwitch",
        description="Device to switch mupad by x, -x syntax",
        mupad="mupad",
    ),
    munumsw=device(
        "nicos_sinq.tasp.devices.mupad.MuNumSwitch",
