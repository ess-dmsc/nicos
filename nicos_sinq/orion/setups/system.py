...
sysconfig = dict(
    ...
    instrument="ORION",
    experiment="Exp",
    datasinks=["conssink", "dmnsink", "livesink", "quiecksink", "asciisink", "cclsink"],
)
...
devices = dict(
    mess=device(
        "nicos_sinq.sxtal.reflist.ReflexList",
        description="Reflection list for measurements",
        reflection_list=[],
    ),
    ublist=device(
        "nicos_sinq.sxtal.reflist.ReflexList",
        description="Reflection list for " "UB matrix refinement",
        reflection_list=[],
    ),
    Sample=device(
        "nicos_sinq.sxtal.sample.SXTalSample",
    ...
    Exp=device(
        "nicos_sinq.devices.experiment.SinqExperiment",
    ...
    asciisink=device(
        "nicos_sinq.sxtal.datasink.SxtalScanSink",
    ...
    cclsink=device(
        "nicos_sinq.sxtal.datasink.CCLSink",
        description="Sink for writing SINQ ASCII files",
