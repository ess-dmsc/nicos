description = "Setup for the FastcomTec MCA coming with the mobile " "chopper unit"
...
devices = dict(
    ...
    fastcomtec=device(
        "nicos_sinq.boa.devices.fastcomtec.FastComtecChannel",
    ...
    boadet=device(
        "nicos_sinq.devices.detector.ControlDetector",
