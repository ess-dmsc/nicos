description = "Setup for the ANDOR CCD camera IKON-L at BOA " "using the CCDWWW server"
...
devices = dict(
    ...
    ccdwww_connector=device(
        "nicos_sinq.boa.devices.ccdwww.CCDWWWConnector",
    ...
    ccdwwwl=device(
        "nicos_sinq.boa.devices.ccdwww.AndorCCD",
    ...
    ccd_cooler=device(
        "nicos_sinq.boa.devices.ccdwww.CCDCooler",
    ...
    boacontrol=device(
        "nicos_sinq.boa.devices.ccdcontrol.BoaControlDetector",
