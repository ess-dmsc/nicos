...
devices = dict(
    ...
    bl1_width=device(
        "nicos.devices.generic.slit.WidthSlitAxis",
        description="Beam limiter 1 opening width",
        slit="bl1",
        unit="mm",
    ),
    bl1_height=device(
        "nicos.devices.generic.slit.HeightSlitAxis",
        description="Beam limiter 1 opening width",
        slit="bl1",
        unit="mm",
    ),
    bl1_center_h=device(
        "nicos.devices.generic.slit.CenterXSlitAxis",
        description="Beam limiter 1 horizontal center",
        slit="bl1",
        unit="mm",
    ),
    bl1_center_v=device(
        "nicos.devices.generic.slit.CenterYSlitAxis",
