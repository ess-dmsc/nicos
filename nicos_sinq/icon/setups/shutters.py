...
devices = dict(
    ...
    he_shutter=device(
        "nicos_sinq.devices.niag_shutter.NiagShutter",
    ...
    exp_shutter=device(
        "nicos_sinq.devices.niag_shutter.NiagExpShutter",
    ...
    fs_he_auto=device(
        ...
        description="Switch which decides if main shutters are managed automatically or manually",
        states=["auto", "manual"],
    ),
    exp_auto=device(
        "nicos.devices.generic.manual.ManualSwitch",
        description="Switch which decides if the experiment shutter is managed automatically or manually",
        states=["auto", "manual"],
    ),
    shuttersink=device(
        "nicos_sinq.icon.devices.shuttersink.ShutterSink",
        description="Sink which manages opening and closing shutters around scans",
        shutter1="he_shutter",
        shutter2="fs_shutter",
        auto="fs_he_auto",
    ),
