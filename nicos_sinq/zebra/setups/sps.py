...
devices = dict(
    ...
    euler_present=device(
        "nicos_sinq.zebra.devices.readeuler.EulerPresent",
    ...
    pgfilter=device(
        "nicos_sinq.devices.s7_switch.S7Switch",
    ...
    shutter=device(
        "nicos_sinq.devices.s7_switch.S7Shutter",
