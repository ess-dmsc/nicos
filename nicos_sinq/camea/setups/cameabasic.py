...
devices = dict(
    ...
    mono=device(
        "nicos_sinq.camea.devices.cameamono.CameaMono",
    ...
    a4=device(
        "nicos_sinq.camea.devices.a4motor.CameaA4Motor",
        description="Real A4 with special offset",
        rawa4="s2t",
        unit="deg",
    ),
    calib1=device(
        "nicos_sinq.camea.devices.calibration.CalibrationData",
    ...
    eis2tcontroller=device(
        "nicos_sinq.camea.devices.eis2tcontroller.EIS2TController",
