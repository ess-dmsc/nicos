...
devices = dict(
    ...
    hv_sample=device(
        ...
        bit=6,
        commandstr="S0011",
        mapping={"ON": False, "OFF": True},
    ),
    tth_connected=device(
        "nicos_sinq.devices.s5_switch.SpsReadable",
    ...
    timepreset=device(
        "nicos_sinq.devices.detector.EpicsTimerActiveChannel",
        epicstimeout=3.0,
    ...
    monitorpreset=device(
        "nicos_sinq.devices.detector.EpicsCounterActiveChannel",
        epicstimeout=3.0,
