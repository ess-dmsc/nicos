...
from nicos_ess.devices.datasources.just_bin_it import (
    Hist1dTof,
    Hist2dDet,
    Hist2dRoi,
    Hist2dTof,
...
class JustBinItImage(ImageChannelMixin, PassiveChannel):
    ...
    def doInit(self, mode):
        ...
        self._processor = createThread("message_processor", self._get_new_messages)
    ...
    def _get_new_messages(self):
        while True:
            try:
                messages = self._histograms_consumer.consume(num_messages=1, timeout=1)
            except RuntimeError:
    ...
    def _process_or_raise(self, messages):
        for msg in messages:
            ...
            try:
                deserialiser = deserialiser_by_schema.get(get_schema(msg.value()))
    ...
    def _create_config(self, interval, identifier):
        ...
        config_base = {"cmd": "config", "msg_id": identifier, "histograms": histograms}
