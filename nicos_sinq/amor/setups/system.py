...
devices = dict(
    ...
    Sample=device(
        "nicos_sinq.amor.devices.sample.AmorSample",
    ...
    FileWriterControl=device(
        "nicos_sinq.devices.datasinks.SinqFileWriterControlSink",
    ...
    NexusStructure=device(
        "nicos_sinq.amor.devices.datasinks.AmorStructureTemplate",
        description="Provides the NeXus structure",
        templatesmodule="nicos_sinq.amor.nexus.nexus_templates",
        templatename="amor_streaming",
    ),
    proton_current=device(
        "nicos_sinq.devices.epics.proton_counter.SINQProtonCurrent",
