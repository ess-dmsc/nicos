...
devices = dict(
    ch1_speed=device(
        "nicos_sinq.devices.epics.base.EpicsAnalogMoveableSinq",
        description="Speed of the master chopper",
        readpv=pvprefix + "DCU1:Speed",
        writepv=pvprefix + "DCU1:Speed:SP",
    ),
    ch1_position=device(
        "nicos_sinq.devices.epics.base.EpicsReadableSinq",
    ...
    ch1_command=device(
        "nicos.devices.epics.pyepics.EpicsStringMoveable",
    ...
    ch2_gear_ratio=device(
        "nicos_sinq.devices.epics.base.EpicsDigitalMoveableSinq",
