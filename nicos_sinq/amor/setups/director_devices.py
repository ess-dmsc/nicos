...
includes = ["detector_stage", "diaphragm1", "diaphragm2", "sample", "diaphragm3"]

devices = dict(
    distances=device(
        "nicos_sinq.amor.devices.director_devices.Distances",
    ...
    amor_director=device(
        "nicos_sinq.amor.devices.director_devices.AmorDirector",
