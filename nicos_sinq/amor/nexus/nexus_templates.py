...
from nicos_sinq.amor.nexus.placeholder import DistancesPlaceholder, UserEmailPlaceholder

from .instrument_components import detectors, instrument, instrument_removable, sample
...
detector_only = {
    "entry1:NXentry": {
        "area_detector": NXLink("AMOR/area_detector"),
        "AMOR:NXinstrument": {"name": DeviceAttribute("Amor", "instrument")},
    }
}

# Template that saves only the sample data
sample_only = {"entry1:NXentry": {"sample:NXsample": {}}}
...
amor_commissioning = {
    ...
    "experiment:NXcollection": {
        ...
        "data:NXevent_data": {
            "data": EventStream(
                topic="FREIA_detector", mod="ev42", source="multiblade", dtype="uint32"
            ),
        },
    ...
    "entry1:NXentry": {
        ...
        "AMOR:NXinstrument": {
            ...
            "detector:NXdetector": {
                ...
                "distance": NXDataset(
                    DistancesPlaceholder("detector", _dv), dtype="float"
                ),
            ...
            "sample:NXsample": {
                ...
                "distance": NXDataset(DistancesPlaceholder("sample", 0), "float"),
                "base_height": "",
                "chi": "",
                "temperature": "",
                "magnetic_field": "",
