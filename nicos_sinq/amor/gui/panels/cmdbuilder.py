...
from nicos.clients.flowui.panels.cmdbuilder import CommandPanel as DefaultCommandPanel
...
class CommandPanel(DefaultCommandPanel):
    ...
    def set_icons(self):
        ...
        self.emergencyStopBtn.setIcon(get_icon("emergency_stop_cross_red-24px.svg"))
        self.pause = False
