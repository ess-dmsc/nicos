...
special_types = [
    (dict(type="double", min=0.5), floatrange(0.5), float, [0.5, 1], [0]),
    (
        dict(type="double", min=-2.5, max=2.3),
        floatrange(-2.5, 2.3),
        float,
        [-2.5, 2.3],
        [4],
...
valid_array1 = [-2.5, 3]
invalid_array1 = ["x"]
complex_types.append((secop_array1, nicos_array1, [], [valid_array1], [invalid_array1]))

secop_struct1 = dict(
    type="struct", members=dict(b=dict(type="bool"), f=dict(type="double"))
)
...
secop_struct2 = dict(
    type="struct", members=dict(a=secop_struct1, b=secop_array2), optional=["b"]
)
...
complex_types.append(
    (
        ...
        nicos_struct2,
        default_struct2,
        [valid_struct2, dict(a=valid_struct1)],  # omit optional member
        [
