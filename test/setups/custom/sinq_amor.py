...
devices = dict(
    slit_controller=device(
        "nicos_sinq.amor.devices.slit.AmorSlitHandler",
    ...
    divergence=device(
        "nicos_sinq.amor.devices.slit.DivergenceAperture",
    ...
    d2v=device(
        "nicos_sinq.amor.devices.slit.AmorSlitLogicalMotor",
