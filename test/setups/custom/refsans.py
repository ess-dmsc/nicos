...
devices = dict(
    ...
    shutter_gamma=device(
        "nicos_mlz.refsans.devices.nok_support.SingleMotorNOK",
        motor=device(
    ...
    nok2=device(
        "nicos_mlz.refsans.devices.nok_support.DoubleMotorNOK",
        nok_start=334.0,
        nok_end=634.0,
        nok_gap=1.0,
    ...
    obs=device(
        "nicos_mlz.refsans.devices.nok_support.NOKPosition",
        reference=device(
    ...
    zb0=device(
        "nicos_mlz.refsans.devices.slits.SingleSlit",
        motor=device(
            "nicos.devices.generic.VirtualMotor",
            unit="mm",
    ...
    zb3=device(
        "nicos_mlz.refsans.devices.slits.DoubleSlit",
        slit_r="zb3r",
        slit_s="zb3s",
        unit="mm x mm",
    ),
    zb3r_acc=device("nicos.devices.generic.ManualMove", abslimits=(0, 10), unit="mm"),
    zb3s_acc=device("nicos.devices.generic.ManualMove", abslimits=(0, 10), unit="mm"),
    configsink=device(
        "nicos_mlz.refsans.datasinks.ConfigObjDatafileSink",
    ),
    vacuum_CB=device(
    ...
    table_acc=device(
        "nicos_mlz.refsans.devices.accuracy.Accuracy",
        absolute=True,
        motor="table_mot",
        analog="table_pos",
        unit="mm",
    ...
    chopper=device(
        "nicos_mlz.refsans.devices.chopper.base.ChopperMaster",
        fmtstr="%s",
        unit="",
    ...
    chopper_speed=device(
        "nicos_mlz.refsans.devices.chopper.virtual.ChopperDisc1",
        chopper=1,
        edge="open",
        gear=1,
    ...
    chopper2=device(
        "nicos_mlz.refsans.devices.chopper.virtual.ChopperDisc2",
        chopper=2,
        gear=1,
        edge="close",
    ...
    chopper2_pos=device(
        "nicos_mlz.refsans.devices.chopper.virtual.ChopperDiscTranslation",
        disc="chopper3",
        curvalue=5,
        speed=0,
        visibility=(),
    ...
    chopper3=device(
        "nicos_mlz.refsans.devices.chopper.virtual.ChopperDisc",
        chopper=3,
        gear=1,
        edge="open",
        speed=0,
    ...
    height=device(
        "nicos_mlz.refsans.devices.tristate.TriState",
        unit="mm",
        port="height_port",
    ),
    height_port=device(
    ...
    bsh_input=device(
        "nicos_mlz.refsans.devices.beamstop.BeamStopDevice",
        unit="mm",
        att="bsh_input_low",
    ),
    bsh=device(
    ...
    bsc=device(
        "nicos_mlz.refsans.devices.beamstop.BeamStopCenter",
        unit="",
        att="bsc_input",
    ),
    backguard=device(
        "nicos_mlz.refsans.devices.skew_motor.SkewMotor",
        one="backguard_1",
        two="backguard_2",
        abslimits=(-60, 60),
        precision=0.1,
    ...
    det_table=device(
        "nicos_mlz.refsans.devices.focuspoint.FocusPoint",
        unit="mm",
        table="det_table_a",
        pivot="det_pivot",
    ...
    det_pivot=device(
        "nicos_mlz.refsans.devices.pivot.PivotPoint",
    ...
    acoder=device(
        "nicos_mlz.refsans.devices.analogencoder.AnalogEncoder",
        device="rawcoder",
        poly=[1, 2],
        unit="mm",
    ),
    identitycoder=device(
        "nicos_mlz.refsans.devices.analogencoder.AnalogEncoder",
        device="rawcoder",
        unit="mm",
    ),
    ...
    dix=device(
        "nicos_mlz.refsans.devices.dimetix.DimetixLaser",
        value="dix_value",
        signal="dix_signal",
    ),
    h2_ctrl_r=device(
    ...
    h2_motor_l=device(
        "nicos_mlz.refsans.devices.analogencoder.AnalogMove",
        device="h2_ctrl_l",
        unit="mm",
        poly=[61.6156, -1],
        visibility=(),
    ...
    ttr=device(
        "nicos_mlz.refsans.devices.converters.Ttr",
        unit="mbar",
        att=device(
            "nicos.devices.generic.ManualMove",
            abslimits=(0, 10),
    ...
    b3=device(
        "nicos_mlz.refsans.devices.slits.DoubleSlitSequence",
