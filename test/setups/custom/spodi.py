...
devices = dict(
    ...
    spodi_image=device(
        "nicos_mlz.spodi.devices.VirtualImage",
        pollinterval=None,
        size=(80, 256),
        background=0,
    ),
    ...
    adet=device(
        "nicos_mlz.spodi.devices.Detector",
        motor="tths",
        detector="basedet",
        pollinterval=None,
        maxage=86400,
    ...
    spodisink=device(
        "nicos_mlz.spodi.datasinks.CaressHistogram",
        filenametemplate=["m1%(pointcounter)08d.ctxt"],
        detectors=["adet"],
    ),
    spodilivesink=device(
        "nicos_mlz.spodi.datasinks.LiveViewSink",
        correctionfile="nicos_mlz/spodi/data/detcorrection.dat",
    ),
    detsampledist=device(
    ...
    sams=device(
        "nicos_mlz.spodi.devices.SampleChanger",
        moveables=["sams_m"],
        mapping={
            "S1": [-3.04],
            "S2": [33.11],
