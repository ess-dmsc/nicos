...
devices = dict(
    phi=device(
        "nicos_mlz.puma.devices.CombAxis",
        motor=device(
    ...
    mtt=device(
        "nicos_mlz.puma.devices.MttAxis",
        motor=device(
            "nicos.devices.generic.VirtualMotor",
            unit="deg",
            abslimits=(-110.1, 0),
    ...
    rd6_cad=device(
        "nicos_mlz.puma.devices.StackedAxis",
        bottom="cad",
        top="rd6",
    ),
    # Magazine
    ...
    magazine=device(
        "nicos_mlz.puma.devices.SenseSwitch",
    ...
    # Magnetic Lock
    mlock_op=device(
        "nicos_mlz.puma.devices.VirtualLogoFeedback",
        input="mlock_set",
        visibility=(),
    ),
    mlock_cl=device(
    ...
    mlock_set=device(
        "nicos_mlz.puma.devices.VirtualDigitalOutput",
        visibility=(),
    ),
    mlock=device(
        "nicos_mlz.puma.devices.MagLock",
