...
devices = dict(
    ...
    m2t=device(
        "nicos_sinq.amor.devices.logical_motor.AmorLogicalMotor",
    ...
    dimetix=device(
        "nicos_sinq.amor.devices.dimetix.EpicsDimetix",
    ...
    nu=device(
        "nicos_sinq.amor.devices.logical_motor.DetectorAngleMotor",
        description="Sample omega",
        com="com",
        coz="coz",
        unit="deg",
        coz_scale_factor=10.0,
    ),
)
