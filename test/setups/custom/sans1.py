...
devices = dict(
    ...
    ieee2=device("nicos_mlz.sans1.devices.ieee.IEEEDevice", valuename="dev1"),
    ieee3=device("nicos_mlz.sans1.devices.ieee.IEEEDevice", valuename="dev1.curvalue"),
    det1_z_ax=device(
    ...
    det1_z=device(
        "nicos_mlz.sans1.devices.detector.DetectorTranslation",
        device="det1_z_ax",
        lock=device(
            "nicos_mlz.sans1.devices.hv.VoltageSwitcher",
            moveable=device(
                "nicos_mlz.sans1.devices.hv.HV",
                unit="V",
                fmtstr="%d",
                supply=device(
                    "nicos.devices.generic.VirtualMotor",
    ...
    bs_xax=device(
        "nicos_mlz.sans1.devices.beamstop.BeamStopAxis",
        motor="bs_ax_motor",
        coder="bs_ax_motor",
        precision=0.1,
        fmtstr="%.2f",
    ...
    bs=device(
        "nicos_mlz.sans1.devices.beamstop.BeamStop",
        xaxis="bs_xax",
        yaxis="bs_yax",
        ypassage=-99,
        unit="mm",
